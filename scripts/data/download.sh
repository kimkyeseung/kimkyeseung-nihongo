#!/usr/bin/env bash
# 원본 데이터 소스 4종을 scripts/data/.cache/ 에 다운로드한다.
...
echo "[1/4] JMDict_Extended (사전 + JLPT급수 + 후리가나 + 피치액센트) 다운로드..."
...
echo "[2/4] KANJIDIC2 영문판 (한자 음독/훈독/뜻/획수) 다운로드..."
